...
BOARD_VENDOR_RAMDISK_KERNEL_MODULES := $(wildcard $(TARGET_KERNEL_DIR)/lib/modules/*.ko)
BOARD_VENDOR_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat $(TARGET_KERNEL_DIR)/lib/modules/modules.load))

# Vendor DLKM
BOARD_USES_VENDOR_DLKMIMAGE := true
BUILDING_VENDOR_DLKM_IMAGE := true
BOARD_VENDOR_KERNEL_MODULES := $(wildcard $(TARGET_KERNEL_DIR)/lib/modules/*.ko)

# Recovery
BOARD_INCLUDE_RECOVERY_DTBO := true
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := $(strip $(shell cat $(TARGET_KERNEL_DIR)/lib/modules/modules.load))
BOARD_RECOVERY_KERNEL_MODULES := $(addsuffix .ko, $(addprefix $(TARGET_KERNEL_DIR)/lib/modules/, $(BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD)))

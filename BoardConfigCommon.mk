...
BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD := $(strip $(shell cat $(TARGET_KERNEL_DIR)/lib/modules/modules.load))
BOARD_RECOVERY_KERNEL_MODULES := $(addsuffix .ko, $(addprefix $(TARGET_KERNEL_DIR)/lib/modules/, $(BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD)))
